...
const ContractTypeDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>
          <strong>Contract Type Information:</strong>
        </Typography>
        ...
        <Typography mt={2}>Are you sure you want to delete this Contract Type?</Typography>
      </DialogContent>
      <DialogActions>
...
export default ContractTypeDeleteConfirm;
