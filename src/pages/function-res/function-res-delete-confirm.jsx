...
const FunctionResDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  const { code, enName, vnName } = data || {};
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        ...
        <Typography mt={2}>Are you sure you want to delete this Function?</Typography>
      </DialogContent>
      <DialogActions>
...
export default FunctionResDeleteConfirm;
