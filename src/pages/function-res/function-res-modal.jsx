...
const FunctionResModal = ({ open, setOpen, onAction, rowData, action }) => {
  ...
  const validationSchema = Yup.object({
    code: Yup.string()
      .required('FunctionRes Code is required')
      .matches(/^[A-Za-z0-9]{4,20}$/, 'Function Code must be more than 2 characters and less than 20 characters'),

    vnName: Yup.string().required('Function English Name is required').max(255, 'FunctionRes Name cannot be longer than 255 characters'),

    enName: Yup.string().required('Function Vietnamese Name is required').max(255, 'Vietnamese Name cannot be longer than 255 characters')
  });
    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography variant="h4" sx={{ marginBottom: 2 }}>
          {action === 'edit' ? 'Update Function' : 'Create Function'}
        </Typography>
...
export default FunctionResModal;
