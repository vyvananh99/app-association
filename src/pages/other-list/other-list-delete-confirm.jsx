...
const OtherListDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        ...
        <Typography mt={2}>Are you sure you want to delete this OtherList?</Typography>
      </DialogContent>
      <DialogActions>
...
export default OtherListDeleteConfirm;
