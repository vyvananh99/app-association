...
const LocationModal = ({ open, setOpen, onAction, rowData, action }) => {
  ...
  const validationSchema = Yup.object({
    id: Yup.string()
      ...
      .matches(/^[A-Za-z0-9]{4,20}$/, 'Location Code must be more than 2 characters and less than 20 characters'),

    vnName: Yup.string().required('Location English Name is required').max(255, 'Location Name cannot be longer than 255 characters'),

    enName: Yup.string().required('Location Vietnamese Name is required').max(255, 'Vietnamese Name cannot be longer than 255 characters')
  });
    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography variant="h4" sx={{ marginBottom: 2 }}>
          {action === 'edit' ? 'Update Location' : 'Create Location'}
        </Typography>
