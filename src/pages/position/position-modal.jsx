...
const LocationModal = ({ open, setOpen, onAction, rowData, action }) => {
  ...
  const validationSchema = Yup.object({
    id: Yup.string()
      ...
      .matches(/^[A-Za-z0-9]{4,20}$/, 'Position Code must be more than 2 characters and less than 20 characters'),

    vnName: Yup.string().required('Position English Name is required').max(255, 'Position Name cannot be longer than 255 characters'),

    enName: Yup.string().required('Position Vietnamese Name is required').max(255, 'Vietnamese Name cannot be longer than 255 characters')
  });
