...
const LocationModal = ({ open, setOpen, onAction, rowData, action }) => {
  ...
  const validationSchema = Yup.object({
    id: Yup.string()
      ...
      .matches(/^[A-Za-z0-9]{1,3}$/, 'City Code must be 1 characters and less than 4 characters'),

    vnName: Yup.string().required('City English Name is required').max(255, 'City Name cannot be longer than 255 characters'),

    enName: Yup.string().required('City Vietnamese Name is required').max(255, 'Vietnamese Name cannot be longer than 255 characters')
  });
    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography variant="h4" sx={{ marginBottom: 2 }}>
          {action === 'edit' ? 'Update City' : 'Create City'}
        </Typography>
