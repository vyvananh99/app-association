...
const SectionDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography fontWeight="bold">Section Information:</Typography>
        ...
        <Typography mt={2}>Are you sure you want to delete this section?</Typography>
      </DialogContent>
      <DialogActions>
...
export default SectionDeleteConfirm;
