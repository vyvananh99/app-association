...
const CompanyDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  const { id, name, vnName } = data || {};
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        ...
        <Typography mt={2}>Are you sure you want to delete this company?</Typography>
      </DialogContent>
      <DialogActions>
