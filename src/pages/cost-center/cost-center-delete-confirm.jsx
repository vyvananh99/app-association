...
const CostCenterDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>
          <strong>Cost Center Information:</strong>
        </Typography>
        ...
        <Typography mt={2}>Are you sure you want to delete this CostCenter?</Typography>
      </DialogContent>
      <DialogActions>
...
export default CostCenterDeleteConfirm;
