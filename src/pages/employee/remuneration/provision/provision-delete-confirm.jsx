...
const ProvisionDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>
          <strong>Provision Information:</strong>
        </Typography>
        ...
        <Typography mt={2}>Are you sure you want to delete this Provision member?</Typography>
      </DialogContent>
      <DialogActions>
...
export default ProvisionDeleteConfirm;
