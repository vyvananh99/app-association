...
const CommendDeleteConfirm = ({ open, setOpen, onConfirm, data, companyData }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>
          <strong>Commend Information:</strong>
        </Typography>
        ...
        <Typography mt={2}>Are you sure you want to delete this Commend?</Typography>
      </DialogContent>
      <DialogActions>
...
export default CommendDeleteConfirm;
