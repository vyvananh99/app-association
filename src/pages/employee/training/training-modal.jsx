...
const TrainingModal = ({ open, setOpen, data, otherListNData, rowData }) => {
  const handleClose = () => {
    setOpen(false);
  };
            ...
            {({ values, handleChange, errors, touched, setFieldValue }) => (
              <Form style={{ width: '100%' }}>
                ...
                >
                  ...
                  <Grid size={{ xs: 6, md: 6 }}>
                    <Field name="city" component={FormTextFieldShrink} label="City" variant="outlined" inputHeight="34.5px" disabled />
                  </Grid>
                  <Grid size={{ xs: 12, md: 12 }}>
                    <Field name="venue" component={FormTextFieldShrink} label="Venue" variant="outlined" inputHeight="34.5px" disabled />
                  </Grid>
                  <Grid size={{ xs: 12, md: 12 }}>
                    <Field name="manday" component={FormTextFieldShrink} label="Manday" variant="outlined" inputHeight="34.5px" disabled />
                  </Grid>
                  <Grid size={{ xs: 6, md: 6 }}>
                    <Field
                      name="manday"
                  ...
                  <Grid size={{ xs: 6, md: 6 }}>
                    <Field name="slot" component={FormTextFieldShrink} label="Slot" variant="outlined" inputHeight="34.5px" disabled />
                  </Grid>
                  <Grid size={{ xs: 6, md: 6 }}>
                    <Field
                      name="totalCost"
