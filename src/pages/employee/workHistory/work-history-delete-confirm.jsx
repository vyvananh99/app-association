...
const DisciplineDeleteConfirm = ({ open, setOpen, onConfirm, data, companyData }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>
          <strong>Discipline Information:</strong>
        </Typography>
        ...
        <Typography mt={2}>Are you sure you want to delete this Discipline?</Typography>
      </DialogContent>
      <DialogActions>
...
export default DisciplineDeleteConfirm;
