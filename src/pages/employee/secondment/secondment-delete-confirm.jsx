...
const SecondmentDeleteConfirm = ({ open, setOpen, onConfirm, data }) => {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>
          <strong>Secondment Information:</strong>
        </Typography>
        ...
        <Typography mt={2}>Are you sure you want to delete this Secondment?</Typography>
      </DialogContent>
      <DialogActions>
...
export default SecondmentDeleteConfirm;
