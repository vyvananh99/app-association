...
const OtherSkillModal = ({ open, setOpen, action, OtherSkillLevel, data, onAction }) => {
      ...
      <Modal open={open} onClose={handleClose} disableEscapeKeyDown>
        ...
        >
          ...
          <Typography variant="h4" sx={{ marginBottom: 2 }}>
            {action === 'edit' ? 'Update skill' : 'Create skill'}
          </Typography>
          ...
          <Formik
            initialValues={{
              ...
              relatTraining: data?.relatTraining || ''
            }}
                  ...
                  <Grid container spacing={2} size={{ xs: 12 }}>
                    ...
                    <Grid size={{ xs: 6 }}>
                      <TextField
                        ...
                        variant="outlined"
                        name="relatTraining"
                        value={values.relatTraining}
                        onChange={handleChange}
                        error={touched.relatTraining && !!errors.relatTraining}
                        helperText={touched.relatTraining && errors.relatTraining}
                        slotProps={{
                          inputLabel: { shrink: true }
                        }}
                        size="small"
