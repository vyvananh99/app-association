...
const MovementSalaryModal = ({
  ...
  // Khi mở modal, nếu có rowData.comId thì lọc phòng ban theo công ty đó
  useEffect(() => {
    if (rowData?.comId) {
  ...
  // Khi chọn lại công ty, lọc lại phòng ban theo selectedCompany
  useEffect(() => {
    if (selectedCompany) {
                          ...
                          <Grid container spacing={2}>
                            ...
                            <Grid size={{ xs: 4 }}>
                              <Field
                                ...
                                minDate={values.effectDate ? dayjs(values.effectDate) : undefined}
                              />
                            </Grid>
                            <Grid size={{ xs: 4 }}>
                              <Field
                          ...
                          <Grid container spacing={2}>
                            ...
                            <Grid size={{ xs: 12 }}>
                              <Field
                                ...
                                onChange={(e) => {
                                  ...
                                  setFieldValue('totalBase', e.target.value);
                                }}
                                component={FormTextFieldShrink}
                                label="Basic"
                                variant="outlined"
                            ...
                            <Grid size={{ xs: 12 }}>
                              <Field
                                ...
                                onChange={(e) => {
                                  if (values.basic) {
                                    setFieldValue('totalBase', values.basic);
                                  } else {
                                    setFieldValue('totalBase', e.target.value);
                                  }
                                }}
