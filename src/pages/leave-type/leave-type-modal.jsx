...
const LeaveTypeModal = ({ open, setOpen, onAction, rowData, action }) => {
  ...
  const validationSchema = Yup.object({
    code: Yup.string()
      ...
      .matches(/^[A-Za-z0-9]{1,2}$/, 'Leave Type Code must be less than 2 characters'),

    name: Yup.string().required('Leave Type Name is required').max(255, 'LeaveType Name cannot be longer than 255 characters'),

    pay: Yup.string().required('Leave Type pay  is required')
  });
    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography variant="h4" sx={{ marginBottom: 2 }}>
          {action === 'edit' ? 'Update Leave Type' : 'Create Leave Type'}
        </Typography>
